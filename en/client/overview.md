...
> If you need to install new probe instances, set up multi-container clusters using Docker Compose, or review sizing recommendations for specialized workloads, refer to: **[Probe Setup & Horizontal Scaling](/en/deploy/overview#chapter-3-probe-setup-horizontal-scaling)**.
...
- [Probe Setup & Horizontal Scaling](/en/deploy/overview#chapter-3-probe-setup-horizontal-scaling) — Detailed container deployment, multi-node scaling, and hardware sizing
