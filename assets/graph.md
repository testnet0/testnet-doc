...
TestNet 提供了直观的**可视化资产拓扑图谱**功能。通过将系统中 8 大核心资产模型自动聚合计算，动态构建节点与边的交互式关系图，方便安全团队从全局层级关联视角洞察网络暴露面与安全风险。
...
在 ECharts 拓扑图谱画布右上角，系统内置了分类图例过滤器。点击对应图例即可快速隐藏/显示特定类型的节点：
...
> [!NOTE] 资产实体结构与上下游关系
> 拓扑图中各个节点展开详情侧边栏时呈现的具体业务属性及层级聚合逻辑，由底层的 8 大核心模型统一管理，详情见 **[资产图谱模型说明](/assets/models)**。
